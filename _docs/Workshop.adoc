...
. OPTIONS
+
Wykorzystywana do uzyskiwania informacji o dopuszczalnej komunikacji z docelowymi zasobami. Musi zwracać nagłówek _Allow_ z informacją o wspieranych metodach.
...
. Wewnątrz utworzonego serwisu dodaj metodę, która będzie dodawać statki do listy, oraz metodę pozwalającę na ich pobieranie.
. Wykorzystując utworzone komponenty wyświetl listę statków oraz formularz służący do dodawania nowych.
...
git clone backend-repo for workshop
----
+
